...
OHC_DESC=		Build and enable the off-heap-cache
OHC_BUILD_DEPENDS=	ohc>=0.7.0:java/ohc
OHC_RUN_DEPENDS=	ohc>=0.7.0:java/ohc
OHC_EXTRA_PATCHES=	${PATCHDIR}/ohc-patches-on
OHC_EXTRA_PATCHES_OFF=	${PATCHDIR}/ohc-patches-off
...
pre-build-OHC-on:
	${LN} -s ${JAVAJARDIR}/ohc-core.jar ${WRKSRC}/lib/ohc-core.jar
